...
## Improvements in This Fork (v0.2.24)
...
- Excel cell ranges are stored as pasteable tabular text instead of their DIB previews, while preserving empty-cell boundaries
- Hardened Windows image clipboard memory bounds and resource cleanup to reduce native heap-corruption exits
